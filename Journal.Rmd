...
impoertando librerias

```{r}
options(scipen = 100)  # get rid of scientific notation in graphs
library(tidyverse) # data manipulation
library(lubridate) # for date manipulation
library(skimr) # for the skim funtcion

#set folder 
setwd("G:\\us_cars_project")

#load data
us_cars <- read_csv("USA_cars_datasets.csv")
...
# most popular brand 
as.data.frame(table(us_cars["brand"])) %>% ggplot(aes(x = Freq,  y = Var1)) +
  geom_bar(stat="identity") + ggtitle("Numbers of sells by brand.") 
